...
public class LeaderElectionSupportTest {
	...
	private static final String testRootNode = "/app1/" + "localhost" + "_";
...
//		super.setUp();
	...
	private ZooKeeper createClient() throws IOException {
		ZooKeeper zooKeeper = new ZooKeeper("172.16.2.199:2181,172.16.2.199:2182,172.16.2.199:2183", 3000, null);
