...
<body>
	...
	<table width="100%" border="1">
		<tr >
			<td width="20%">
<!-- 				<a href="javascript:installCer(1);">安装证书</a><br/> -->
				<a href="javascript:installCer(2);">签章</a><br/>
			</td>
			<td>
				<div  id="myid" style="height: 700px ">
					<iframe src="http://172.16.2.146:8080/cfcaTest/verify?userId=8160" width="100%" height="100%" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="auto" allowtransparency="yes"></iframe>;
				</div>
